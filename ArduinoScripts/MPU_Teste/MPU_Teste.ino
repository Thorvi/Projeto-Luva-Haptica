...
//float A_cal[6] = {-5724.0, -680, 16420, 0.994, 1.000, 1.014}; // 0..2 offset xyz, 3..5 scale xyz
...
//float G_off[3] = { -1037.0, -1410.0, -460.0}; //raw offsets, determined for gyro at rest
float G_off[3] = { 0, 0, 0};
